...
- Read-only Observer feed test: `python tools/sentinel_observer_feed.py --summary-file /tmp/metaos_domain_events/_summary/summary_<TS>.json`
- Replay logs are written to `/tmp/_observer_test/replay_<TS>.json`.
