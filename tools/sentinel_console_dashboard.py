...
def main() -> int:
    ...
    try:
        ...
        for item in items:
            ...
            score = final.get("final_score", item.get("score"))
            direction = final.get("final_direction", item.get("direction"))
            risk_level = final.get("final_risk_level", item.get("risk_level"))
            confidence = final.get("final_confidence", item.get("confidence"))
