...
# ================================
# 🔹 핵심 SHA 동기화
# 실제 exec_trigger_v1.yaml SHA
EXPECTED_POLICY_SHA = "df9016024b1ba5caea749301eb8336c8c2425e8e83ed20bcd9d31613fdf6c008"
# ================================
...
def main() -> int:
    ...
    if policy_sha != EXPECTED_POLICY_SHA:
        raise ValueError(f"policy sha256 mismatch: expected={EXPECTED_POLICY_SHA} got={policy_sha}")
